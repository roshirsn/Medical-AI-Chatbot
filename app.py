...
# # # Create retrieval + response chain
...
def is_casual_message(user_input: str) -> str | None:
    ...
    casual_responses = {
        ...
        "thank you": "You're welcome!",
        "thanks": "Glad to help!",
        "fuck you": "Let's stay respectful.",
        "you are an idiot": "Let's keep the conversation respectful."
    }
    return casual_responses.get(input_lower, None)
...
# Assuming you have a retriever and are using it for the chain
rag_chain = ConversationalRetrievalChain.from_llm(
    llm=llm,
    retriever=retriever,  # Your retriever here
    memory=memory,
    # Remove any 'combine_docs_chain' argument if passed redundantly
)
